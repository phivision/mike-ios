...
class UserCenterModel : NSObject, NSCoding{
	...
	var bgTitle : AnyObject!
	var biography : AnyObject!
	...
	init(fromDictionary dictionary: [String:Any]){
		bgImage = dictionary["BgImage"] as? AnyObject
		bgTitle = dictionary["BgTitle"] as? AnyObject
		biography = dictionary["Biography"] as? AnyObject
		birthday = dictionary["Birthday"] as? AnyObject
    ...
    */
	...
	{
         bgImage = aDecoder.decodeObject(forKey: "BgImage") as? AnyObject
         bgTitle = aDecoder.decodeObject(forKey: "BgTitle") as? AnyObject
         biography = aDecoder.decodeObject(forKey: "Biography") as? AnyObject
         birthday = aDecoder.decodeObject(forKey: "Birthday") as? AnyObject
         ...
         height = aDecoder.decodeObject(forKey: "Height") as? AnyObject
         ...
         weight = aDecoder.decodeObject(forKey: "Weight") as? AnyObject
